...
class Api::V1::ProductsControllerUpdateTest < ActionDispatch::IntegrationTest
  ...
  test 'success to update product' do
    patch api_v1_product_url(@product), params: { product: { price_cents: 30_000 } }, as: :json
    assert_response 200
  end
  ...
  test 'should update product and return set data' do
    ...
    patch api_v1_product_url(@product), params: { product: { price_cents: price_cents } }, as: :json
